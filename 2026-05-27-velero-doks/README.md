...
Getestet gegen einen DigitalOcean Kubernetes Cluster (DOKS) — Velero v1.17,
Plugin velero-plugin-for-aws v1.13. Ablage: DigitalOcean Spaces
...
Getestet gegen einen DOKS-Cluster mit Velero v1.17 und dem Plugin
